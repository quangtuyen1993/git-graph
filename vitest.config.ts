  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        'src/extension/services/forge/github/github-constants.ts',
        'src/extension/services/forge/github/github-auth.ts',
        'src/extension/services/forge/github/github-api.ts',
        'src/extension/services/forge/github/github-mapper.ts',
        'src/extension/services/forge/github/github-cloud.provider.ts',
